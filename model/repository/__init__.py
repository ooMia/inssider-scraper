...
2. relationship의 타입을 정의할 때 반드시 클래스명을 문자열로 작성합니다.
    ...
    - 예시: account: Mapped["Account"] = relationship(...)
...
from .account import Profile, Follow  # noqa: F401
from .post import Post  # noqa: F401
from .post import Category  # noqa: F401

from .etc import Video, EmailVerificationCode, AuthorizationCode  # noqa: F401
